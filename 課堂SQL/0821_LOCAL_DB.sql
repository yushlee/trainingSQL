...
-- 1.INSERT 新增資料到資料表中
-- 指定欄位名稱可省略不寫，但是VALUES必須完整且與欄位順序相同
INSERT INTO STORE_INFORMATION (STORE_ID,STORE_NAME,SALES,STORE_DATE, GEOGRAPHY_ID) 
	VALUES (10, 'Apple Inc', 5500, '2018-03-09 00:00:00', 3);

INSERT INTO STORE_INFORMATION VALUES (11, 'samsung Inc', 2200, STR_TO_DATE('2021-08-15 00:00:00', "%Y-%m-%d %T"), 3);
...
-- INSERT來源可以是一個查詢的結果，達成"批次新增"的功能
...
SELECT * FROM STORE_INFORMATION_2;

-- 2.UPDATE 更改資料表中的資料
-- UPDATE "表格名"SET "欄位1" = [新值]WHERE {條件}
-- 如果有多筆資料符合條件的話，每一筆符合條件的資料都會被修改的
UPDATE STORE_INFORMATION SET SALES = 2400 WHERE STORE_ID = 11;
UPDATE STORE_INFORMATION SET SALES = 2500, STORE_NAME = 'SAMSUNG INC' WHERE STORE_ID = 11;
