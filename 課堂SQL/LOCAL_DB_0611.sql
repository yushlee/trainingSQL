...
(
  ...
  DATE_ONE DATE,
  TIMESTAMP_ONE TIMESTAMP WITH TIME ZONE,
...
(
  ...
  COLUMN2 VARCHAR(9),
  COLUMN_NO1 NUMERIC(5, 2),
  DATE_ONE DATE, -- 年月日時分秒
  TIMESTAMP_ONE TIMESTAMP -- 年月日時分秒(毫妙)
);

SELECT * FROM TABLE1;

INSERT INTO local_db.table1 (COLUMN1, COLUMN2, COLUMN_NO1, DATE_ONE, TIMESTAMP_ONE) VALUES('ABCD', 'ABCD', 123.455, '2023-06-11 12:12:12', '2023-06-11 12:12:12.123');
