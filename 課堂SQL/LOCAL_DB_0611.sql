...
VALUES (10,'Apple Inc', 6600, '2023-06-11 16:25:30', 3);

-- 新增時可省略宣告欄位名稱(不建議此做法，因為資料表可能會新增欄位)
INSERT INTO STORE_INFORMATION VALUES (11,'Apple Inc 2', 6600, '2023-06-11 16:25:30', 3);

-- INSERT INTO的資料來源可以是一個SQL語句的查詢結果(欄位個數、欄位型態必須一致)
...
UPDATE STORE_INFORMATION SET STORE_NAME = 'HTC NEW', SALES= '7755' WHERE STORE_ID = 12;

-- 3.DELETE 刪除資料表中的資料
-- DELETE FROM "表格名"WHERE {條件} 
DELETE FROM STORE_INFORMATION WHERE GEOGRAPHY_ID = 3;
