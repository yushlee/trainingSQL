...
SELECT CONCAT(STORE_ID, STORE_NAME) "CONCAT_FIELD" 
FROM STORE_INFORMATION;

SELECT STORE_ID || '-' || STORE_NAME || SALES "CONCAT_FIELD" 
FROM STORE_INFORMATION;

SELECT STORE_NAME, SUBSTR(STORE_NAME, 4), SUBSTR(STORE_NAME, 4, 4) 
FROM STORE_INFORMATION;

SELECT LTRIM(STORE_NAME), RTRIM(STORE_NAME), TRIM(STORE_NAME) 
FROM STORE_INFORMATION;

INSERT INTO STORE_INFORMATION 
(STORE_ID, STORE_NAME, SALES, STORE_DATE, GEOGRAPHY_ID)
VALUES (10, 'Apple', 5000, '2019-05-05', 3);

UPDATE STORE_INFORMATION 
SET SALES = 7000, STORE_NAME = 'Apple Inc'
WHERE STORE_ID = 10;
